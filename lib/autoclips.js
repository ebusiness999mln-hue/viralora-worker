...
async function renderAutoClips(job, supabase) {
  ...
  for (let i = 0; i < picks.length; i++) {
    ...
    try {
      ...
      const vertical = `crop=ih*9/16:ih:(iw-ih*9/16)/2:0,scale=1080:1920,drawtext=fontfile=${FONT}:text='${p.caption}':fontsize=56:fontcolor=white:x=(w-text_w)/2:y=h-320:box=1:boxcolor=black@0.5`
